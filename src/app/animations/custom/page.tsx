    ...
    <div className="  p-8">
      <main className=" w-full lg:max-w-[70vw] mx-auto space-y-6">
        ...
        <section className=" grid place-items-center">
          <div className=" card  grid place-items-center relative rounded-xl p-0.5 bg-neutral-800">
            <div className="bg-neutral-900 h-full w-full rounded-xl grid place-items-center z-10">
